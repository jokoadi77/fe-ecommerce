...
const ErrorView = () => {
    ...
    <div className="container flex flex-col md:flex-row items-center justify-between px-5 text-gray-700">
            ...
            <Link className="px-5 inline py-3 text-sm font-medium leading-5 shadow-2xl text-white transition-all duration-400 border border-transparent rounded-lg focus:outline-none bg-accent active:bg-base-200 hover:bg-neutral">back to homepage</Link>
    </div>
