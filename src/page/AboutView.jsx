        ...
        <div className="flex flex-col items-center justify-between lg:flex-row py-16">
            <div className=" relative ">
                ...
                <div className="lg:max-w-xl lg:pr-5 relative z-40">
                    ...
                    <div className="mt-10 flex flex-col items-center md:flex-row">
                        <Link to="/products" className="mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-accent px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-neutral focus:outline-none md:mr-4 md:mb-0 md:w-auto">
                            View More</Link>
                        <Link to="/" aria-label="" className="group inline-flex items-center font-semibold text-g1">Watch how
                            it works
            ...
            <div className="relative hidden lg:ml-32 lg:block lg:w-1/2">
                ...
                <div className="abg-orange-400 mx-auto w-fit overflow-hidden rounded-[6rem] rounded-br-none rounded-tl-none">
                     <img src="https://images.unsplash.com/photo-1504198458649-3128b932f49e?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8Y2xvdGhlc3xlbnwwfHwwfHx8MA%3D%3D"/>
                </div>
            </div>
        </div>
    </div> 
